...
public void getAttachMentName(Part part)throws Exception{
	if(part.isMimeType("multipart/*")){
		Multipart mp = (Multipart)part.getContent();
		for(int i=0;i<mp.getCount();i++){
			BodyPart mpart = mp.getBodyPart(i);
		...
		getAttachMentName((Part)part.getContent());
	}
}
...
/*public static void main(String args[])throws Exception{
	...
	String username ="1050416617@qq.com";     //【wwp_1124】
	String password ="pzojbuyawasqbbfh";       //【........】
	...
	for(int i=0;i<message.length;i++){
		...
		File file=new File("c:\\tmp\\coffeecat1124");
		if(!file.exists()){
			file.mkdirs();
		}
